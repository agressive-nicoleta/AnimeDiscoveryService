<template>
  <div class="collection">
    ...
    <div class="anime-list">
      <BrowseCard
        v-for="anime in recentlyUpdatedList"
        :key="anime.index"
        :title="anime.title"
        :poster="anime.image"
        :type="anime.type"
...
export default {
  ...
  created: function () {
    this.$store.dispatch("fetchRecentlyUpdatedCollection1");
  },
  computed: {
    recentlyUpdatedList: function () {
      return this.$store.state.categories.recentlyUpdatedList;
    },
    isLoading: function () {
      return this.$store.state.categories.isRecentlyUpdatedtLoading;
    },
  },
  methods: {
